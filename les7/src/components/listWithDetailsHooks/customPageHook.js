...
import ItemListCustomHook from './itemListCustomHook';
import ItemOneCustomHook from './itemOneCustomHook';
...
export default class CustomPageHook extends React.Component  {
